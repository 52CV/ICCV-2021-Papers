...
## 18.Transformers
* [Generic Attention-model Explainability for Interpreting Bi-Modal and Encoder-Decoder Transformers](https://arxiv.org/abs/2103.15679)<br>:star:[code](https://github.com/hila-chefer/Transformer-MM-Explainability)
* 密集预测
  * [Pyramid Vision Transformer: A Versatile Backbone for Dense Prediction without Convolutions](https://arxiv.org/abs/2102.12122)<br>:open_mouth:oral:star:[code](https://github.com/whai362/PVT):newspaper:解读[大白话Pyramid Vision Transformer](https://mp.weixin.qq.com/s/oJHZWmStQYYzEEOveiuQrQ)
...
## 12.Image/Fine-Grained Classification(图像分类/细粒度分类) 
* 长尾识别
